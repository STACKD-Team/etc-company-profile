                    ...
                    <div class="grid gap-5 xl:grid-cols-[minmax(0,1fr)_220px] xl:items-center">
                        <div class="min-w-0">
                            ...
                            <dl class="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                                <div class="rounded-box bg-etc-surface-container p-3">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            @else
                                <p class="rounded-box bg-etc-surface-container p-3 text-sm text-etc-on-muted">Rapor akan tampil setelah dipublikasikan admin.</p>
                            @endif
                        </div>
                    </div>
                </article>
