<x-layouts.public title="Galeri Kegiatan">
    ...
    <section class="bg-[#fff8f8] py-20">
        <div class="mx-auto max-w-[1120px] px-5 text-center lg:px-0">
            ...
            <h1 class="mt-4 font-heading text-[42px] font-black leading-tight text-etc-on-surface md:text-[56px]">Kegiatan belajar ETC Planet</h1>
            <p class="mx-auto mt-5 max-w-2xl text-[16px] leading-8 text-etc-on-muted">Galeri berasal dari CMS contents type gallery.</p>
        </div>
    </section>
    ...
    <section class="bg-etc-charcoal py-20 text-white">
        <div class="mx-auto max-w-[1120px] px-5 lg:px-0">
            ...
            @else
                <div class="rounded-[22px] border border-white/10 bg-white/5 p-10 text-center text-white/75">
