...
@php
    ...
    $roomOptions = $rooms->pluck('name', 'id')->all();
...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <x-ui.select name="room_id" label="Room" :value="$class->room_id" placeholder="Belum ditentukan" :options="$roomOptions" />
...
<div class="mt-6 flex flex-wrap gap-3">
    ...
    <x-ui.button :href="route('admin.class.index')" outlined color="gray">Batal</x-ui.button>
</div>
