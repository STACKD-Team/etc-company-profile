        ...
        <x-ui.panel>
            <div class="flex flex-col justify-between gap-4 md:flex-row md:items-start">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <x-ui.button :href="route('admin.payment.show', ['payment' => $registration])" outlined>Pembayaran</x-ui.button>
                    <x-ui.button :href="route('admin.registration.edit', $registration)">Edit</x-ui.button>
                </div>
            </div>
        </x-ui.panel>
