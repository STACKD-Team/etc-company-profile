...
<x-layouts.dashboard :title="$title" area="instructor" active="reports">
    ...
    <form method="POST" action="{{ $action }}" class="space-y-6">
        ...
        <x-ui.panel heading="Written Test" description="Setiap komponen bernilai 0-20. Total dihitung otomatis oleh sistem." icon="heroicon-o-pencil-square">
        ...
        <x-ui.panel heading="Overall Class Assessment" description="Nilai observasi selama proses pembelajaran." icon="heroicon-o-chart-bar-square">
            <div class="grid gap-5 sm:grid-cols-2 xl:grid-cols-5">
                @foreach ([
        ...
        <x-ui.panel heading="Hasil Akhir" description="Lengkapi rekomendasi kelas dan catatan untuk siswa." icon="heroicon-o-trophy">
