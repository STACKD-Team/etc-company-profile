...
@php
    ...
    $defaultItems = [
        'admin' => [
            ...
            ['label' => 'Pesan Kontak', 'route' => 'admin.contact-messages.index', 'url' => '#', 'key' => 'contact-messages', 'icon' => 'mail'],
            ['label' => 'Chatbot Logs', 'route' => 'admin.chatbot-logs.index', 'url' => '#', 'key' => 'chatbot-logs', 'icon' => 'forum'],
